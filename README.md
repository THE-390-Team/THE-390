...
/usr/lib/python3/dist-packages/requests/__init__.py                                        58     18    69%
...
/usr/lib/python3/dist-packages/six.py                                                     504    245    51%
/usr/lib/python3/dist-packages/urllib3/__init__.py                                         34      8    76%
/usr/lib/python3/dist-packages/urllib3/_collections.py                                    188    137    27%
/usr/lib/python3/dist-packages/urllib3/_version.py                                          1      0   100%
/usr/lib/python3/dist-packages/urllib3/connection.py                                      217    151    30%
/usr/lib/python3/dist-packages/urllib3/connectionpool.py                                  334    269    19%
/usr/lib/python3/dist-packages/urllib3/contrib/__init__.py                                  0      0   100%
/usr/lib/python3/dist-packages/urllib3/contrib/_appengine_environ.py                       11      1    91%
/usr/lib/python3/dist-packages/urllib3/contrib/socks.py                                    76     67    12%
/usr/lib/python3/dist-packages/urllib3/exceptions.py                                      116     34    71%
/usr/lib/python3/dist-packages/urllib3/fields.py                                           90     70    22%
/usr/lib/python3/dist-packages/urllib3/filepost.py                                         43     30    30%
/usr/lib/python3/dist-packages/urllib3/packages/__init__.py                                 8      2    75%
/usr/lib/python3/dist-packages/urllib3/packages/ssl_match_hostname/__init__.py             11      1    91%
/usr/lib/python3/dist-packages/urllib3/packages/ssl_match_hostname/_implementation.py      73     62    15%
/usr/lib/python3/dist-packages/urllib3/poolmanager.py                                     194    149    23%
/usr/lib/python3/dist-packages/urllib3/request.py                                          39     28    28%
/usr/lib/python3/dist-packages/urllib3/response.py                                        405    328    19%
/usr/lib/python3/dist-packages/urllib3/util/__init__.py                                    10      0   100%
/usr/lib/python3/dist-packages/urllib3/util/connection.py                                  72     49    32%
/usr/lib/python3/dist-packages/urllib3/util/proxy.py                                       14     11    21%
/usr/lib/python3/dist-packages/urllib3/util/queue.py                                       14      5    64%
/usr/lib/python3/dist-packages/urllib3/util/request.py                                     52     37    29%
/usr/lib/python3/dist-packages/urllib3/util/response.py                                    38     31    18%
/usr/lib/python3/dist-packages/urllib3/util/retry.py                                      205    138    33%
/usr/lib/python3/dist-packages/urllib3/util/ssl_.py                                       192    144    25%
/usr/lib/python3/dist-packages/urllib3/util/ssltransport.py                               139    134     4%
/usr/lib/python3/dist-packages/urllib3/util/timeout.py                                     64     42    34%
/usr/lib/python3/dist-packages/urllib3/util/url.py                                        205    152    26%
/usr/lib/python3/dist-packages/urllib3/util/wait.py                                        77     59    23%
...
[90m  │[39m [90mCypress:[39m        13.6.6                                                                         [90m│[39m
[90m  │[39m [90mBrowser:[39m        Electron 118 [90m(headless)[39m                                                        [90m│[39m
[90m  │[39m [90mNode Version:[39m   [0mv18.19.1 [90m(/usr/local/bin/node)[39m[0m                                                 [90m│[39m
[90m  │[39m [90mSpecs:[39m          [0m2 found (AppTesting.cy.js, PropertyTesting.cy.js)[0m                              [90m│[39m
[90m  │[39m [90mSearched:[39m       [0mcypress/e2e/**/*.cy.{js,jsx,ts,tsx}[0m                                            [90m│[39m
[90m  

                                                         
  Running:  [90mAppTesting.cy.js[39m                                                                [90m(1 of 2)[39m

[0m[0m
[0m  Header Navigation[0m
  [32m  ✓[0m[90m should navigate to login page[0m[90m (1215ms)[0m

[0m  Sign Up Form[0m
  [32m  ✓[0m[90m should fill out the sign-up form and submit successfully[0m[90m (3072ms)[0m

[0m  Login Form[0m
  [32m  ✓[0m[90m should fill out the form and submit successfully[0m[90m (889ms)[0m

[0m  Profile Editing Modal[0m
  [32m  ✓[0m[90m should open the modal when the "Edit Profile" button is clicked[0m[90m (1404ms)[0m

[0m  Logout[0m
  [32m  ✓[0m[90m Login and then logout[0m[90m (1494ms)[0m


[92m [0m[32m 5 passing[0m[90m (8s)[0m
...
[90m  │[39m [90mSpec Ran:[39m     [32m[32mAppTesting.cy.js[32m[39m                                                                 [90m│[39m
[90m  
                                                                                                    
  Running:  [90mPropertyTesting.cy.js[39m                                                           [90m(2 of 2)[39m

[0m[0m
[0m  Navigate to Property Page from Profile and go back[0m
  [32m  ✓[0m[90m Navigate to Property Page from Profile[0m[90m (2596ms)[0m

[0m  Navigate to Create Unit/Parking/Locker Form from Profile and go back[0m
  [32m  ✓[0m[90m Navigate to Create Unit from profile[0m[90m (1904ms)[0m
  [32m  ✓[0m[90m Navigate to Create Parking from profile[0m[90m (1909ms)[0m
  [32m  ✓[0m[90m Navigate to Create Locker from profile[0m[90m (1858ms)[0m

[0m  Navigate to Create Property Form from Profile and go back[0m
  [32m  ✓[0m[90m Navigate to Create Property from Profile[0m[90m (1787ms)[0m

[0m  Enter Create Unit Form[0m
  [32m  ✓[0m[90m Fill out the create unit form and submit successfully[0m[90m (2080ms)[0m

[0m  Enter Create Parking Form[0m
  [32m  ✓[0m[90m Fill out the create parking form and submit successfully[0m[90m (1908ms)[0m

[0m  Enter Create Locker Form[0m
  [32m  ✓[0m[90m should fill out the create locker form and submit successfully[0m[90m (1915ms)[0m

[0m  Enter Create Property Form[0m
  [32m  ✓[0m[90m should fill out the create locker form and submit successfully[0m[90m (3127ms)[0m


[92m [0m[32m 9 passing[0m[90m (19s)[0m


[32m  ([4m[1mResults[22m[24m)[39m

[90m  
[90m  │[39m [90mTests:[39m        [32m9[39m                                                                                [90m│[39m
[90m  │[39m [90mPassing:[39m      [32m9[39m                                                                                [90m│[39m
[90m  │[39m [90mFailing:[39m      [32m0[39m                                                                                [90m│[39m
[90m  │[39m [90mPending:[39m      [32m0[39m                                                                                [90m│[39m
[90m  │[39m [90mSkipped:[39m      [32m0[39m                                                                                [90m│[39m
[90m  │[39m [90mScreenshots:[39m  [32m0[39m                                                                                [90m│[39m
[90m  │[39m [90mVideo:[39m        [32mfalse[39m                                                                            [90m│[39m
[90m  │[39m [90mDuration:[39m     [32m19 seconds[39m                                                                       [90m│[39m
[90m  │[39m [90mSpec Ran:[39m     [32m[32mPropertyTesting.cy.js[32m[39m                                                            [90m│[39m
[90m  
[90m====================================================================================================[39m

[0m  ([4m[1mRun Finished[22m[24m)[0m

[0mAppTesting.cy.js[0m                         [90m00:08[39m        [0m5[0m        [32m5[39m        [90m-[39m        [90m-[39m        [90m-[39m [90m│[39m
[0mPropertyTesting.cy.js[0m                    [90m00:19[39m        [0m9[0m        [32m9[39m        [90m-[39m        [90m-[39m        [90m-[39m [90m│[39m
[90m   [39m [32m✔[39m  [32mAll specs passed![39m                        [90m00:27[39m       [0m14[0m       [32m14[39m        [90m-[39m        [90m-[39m        [90m-[39m [90m [39m

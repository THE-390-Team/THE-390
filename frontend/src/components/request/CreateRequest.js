...
const CreateRequest = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.description.length > 200) {
      errors.description =
        'Request description must be less than 200 characters'
      isValid = false
    }
  ...
  const handleSubmit = e => {
    ...
    if (validateForm()) {
      ...
      axiosInstance
        ...
        .postForm(
          `properties/property-profile/${propertyId}/common-facilities/`,
          {
            assigned_employee: '',
            type: formData.type,
      ...
      <Form className='py-5 text-dark' onSubmit={handleSubmit}>
        <Row className='mb-3'>
          <Form.Group as={Col} controlId='formGridType'>
            ...
            >
              <option value='Miscelanious' data-testid='misc-test'>
                Miscelanious
              </option>
              <option value='Intercom' data-testid='intercom-test'>
                Intercom
              </option>
              <option value='Access' data-testid='access-test'>
                Access
              </option>
              <option value='Move_In' data-testid='move-in-test'>
                Move In
              </option>
              <option value='Move_Out' data-testid='move-out-test'>
                Move Out
              </option>
              <option value='Violation_Report' data-testid='violation-test'>
                Violation Report
              </option>
              <option value='Deficiency_Report' data-testid='deficiency-test'>
                Deficiency Report
              </option>
            </Form.Select>
          </Form.Group>

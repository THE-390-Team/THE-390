  ...
  const FetchPropertiesFinacials = async () => {
    try {
      const response = await axiosInstance.get(
        `/profiles/company-profile/${comapanyID}/finance-report/`,
      )
              ...
              <Accordion.Item key={propertyKey} eventKey={propertyKey}>
                ...
                >
                  ...
                  <Table bordered hover>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style={{ width: '50%', textAlign: 'center' }}>
                          ${property.properties[propertyKey].condo_fee}
                        </td>
                      </tr>
                    </tbody>
                  </Table>
                  ...
                  >
                    ...
                    <tbody>
                      {property.properties[propertyKey].parkings.map(
                        parking => (
                          <tr key={parking.id}>
                      ...
                      <tr>
                        ...
                        <td style={{ width: '50%', textAlign: 'center' }}>
                          ${property.properties[propertyKey].parking_fee}
                        </td>
                      </tr>
                    </tbody>
                  </Table>
                  ...
                  >
                    ...
                    <tbody>
                      {property.properties[propertyKey].storages.map(
                        storage => (
                          <tr key={storage.id}>
                      ...
                      <tr>
                        ...
                        <td style={{ width: '50%', textAlign: 'center' }}>
                          ${property.properties[propertyKey].storage_fee}
                        </td>
                      </tr>
                    </tbody>
                  </Table>

...
router.register(
    r"employee-profile", EmployeeProfileViewSet, basename="employee-profiles"
)
...
urlpatterns = [
    ...
    path(
        "company-profile/<int:company_id>/property-profiles/",
    ...
    # employee
    path(
        "public-profile/<int:user_id>/requests/",
        ServiceRequestViewSet.as_view({"get": "get_user_request"}),
    ),
    path(
        "company-profile/<int:company_id>/requests/",
        ServiceRequestViewSet.as_view({"get": "get_company_request"}),
    ),
]

...
class Profile(models.Model):
    ...
    avatar = models.ImageField(
        upload_to="avatar_images", default="avatar_images/pp.jpg"
    )
...
class EmployeeProfile(Profile):
    ...
    position = models.CharField(
        max_length=100, choices=Position.choices, default=Position.DAILY_OPERATIONS
    )
    ...
    def send_registration_key(self, key, user):
        ...
        try:
            ...
            mail = mt.MailFromTemplate(
                sender=mt.Address(
                    email="mailtrap@condocare.space", name="Mailtrap Test"
                ),

...
class CompanyFinanceView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        for property in properties:
            ...
            condo_budget = []
            condos = CondoUnit.objects.filter(
                property=property, public_profile__isnull=False
            )
            for condo in condos:
            ...
            company_total_fees += (
                total_condo_fees + total_storage_fees + total_parking_fees
            )
            company_total_expenses += (
                total_condo_expenses + total_parking_expenses + total_storage_expenses
            )
            ...
            data[f"{property.id}"] = {
                ...
                "expenses": total_condo_expenses
                + total_parking_expenses
                + total_storage_expenses,
            }

...
class RegistrationKey(models.Model):
    ...
    user = models.ForeignKey(
        "user_profile.PublicProfile", on_delete=models.CASCADE, null=False, blank=False
    )
...
class CondoRegistrationKey(RegistrationKey):
    ...
    unit = models.ForeignKey(
        "properties.CondoUnit", on_delete=models.CASCADE, blank=False
    )
...
class ParkingRegistrationKey(RegistrationKey):
    ...
    unit = models.ForeignKey(
        "properties.ParkingUnit", on_delete=models.CASCADE, blank=False
    )
    objects = RegistrationKeyManager()
...
class StorageRegistrationKey(RegistrationKey):
    ...
    unit = models.ForeignKey(
        "properties.StorageUnit", on_delete=models.CASCADE, blank=False
    )
    objects = RegistrationKeyManager()

...
class CreateCondoRegistrationKeyTestCase(TestCase):
    ...
    def test_create_registration_key(self):
        ...
        registration_key = CondoRegistrationKey.objects.get(
            user=self.public, unit=self.condo
        )
    ...
    def test_create_registration_key_with_invalid_user(self):
        ...
        self.assertEqual(
            response.data["details"], "There is no user with the given email"
        )
    ...
    def test_create_registration_key_with_non_public_user(self):
        ...
        self.assertEqual(
            ...
            "The user associated with this email is not a public user",
        )
    ...
    def test_create_registration_key_with_invalid_unit(self):
        ...
        self.assertEqual(
            response.data["details"],
            "There is no condo unit associated with the given id",
        )
    ...
    def test_create_registration_key_with_invalid_company(self):
        ...
        self.assertEqual(
            response.data["details"],
            "There is no Company Profile associated with the given id",
        )
...
class CreateStorageRegistrationKeyTestCase(TestCase):
    ...
    def test_create_registration_key(self):
        ...
        self.assertTrue(response.data["is_owner"])
        self.assertTrue("key" in response.data)
        registration_key = StorageRegistrationKey.objects.get(
            user=self.public, unit=self.storage
        )
        self.assertEqual(registration_key.key, response.data["key"])
    ...
    def test_create_registration_key_with_invalid_unit(self):
        ...
        self.assertEqual(
            response.data["details"],
            "There is no storage unit associated with the given id",
        )
...
class CreateParkingRegistrationKeyTestCase(TestCase):
    ...
    def test_create_registration_key(self):
        ...
        self.assertTrue(response.data["is_owner"])
        self.assertTrue("key" in response.data)
        registration_key = ParkingRegistrationKey.objects.get(
            user=self.public, unit=self.parking
        )
        self.assertEqual(registration_key.key, response.data["key"])
    ...
    def test_create_registration_key_with_invalid_unit(self):
        ...
        self.assertEqual(
            response.data["details"],
            "There is no parking unit associated with the given id",
        )
